  ...
  it('copies and downloads one reviewed artifact until revisions change', async () => {
    ...
    forgeActions.initializeDraft({
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'Benthos Aberration',
          role: 'Antagonist',
          description: 'Crushing deep-station entity stalking the vents of Benthos Node 1.',
          disposition: 'VILLAIN',
  ...
  it('source-backed compliant Blueprint compiles and enables both export actions', async () => {
    ...
    forgeActions.initializeDraft({
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'Omega Aberration',
          role: 'Antagonist',
          description: 'Escaped containment specimen hunting through Sub-Level 3.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
    ...
    forgeActions.initializeDraft({
      ...
      cast: [
        ...
        },
        {
          ...
          name: 'Benthos Aberration',
          role: 'Antagonist',
          description: 'Deep-node predator circling Benthos Node 1.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
