      ...
      <div className="max-w-4xl w-full space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <button
            ...
            className="group relative p-10 border-2 border-zinc-900 hover:border-fresh-blood transition-all duration-500 text-left space-y-6 bg-zinc-950/50 backdrop-blur-sm"
          >
          ...
          <button
            ...
            className="group relative p-10 border-2 border-zinc-900 hover:border-system-green transition-all duration-500 text-left space-y-6 bg-zinc-950/50 backdrop-blur-sm"
          >
            <div className="flex items-center justify-between">
