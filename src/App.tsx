...
export default function App() {
  ...
  const isEnginePhase =
    ['LATENT', 'MANIFEST', 'TERMINAL', 'TERMINATED', 'ENGINE', 'RUNTIME', 'RELEASE'].includes(phase) ||
    (phase !== 'HUB' && phase !== 'FORGE' && phase !== 'ARCHITECT' && phase !== 'VOICE');
  ...
  const renderContent = () => {
    ...
    if (isEnginePhase && phase !== 'HUB') return <Engine />;
