  ...
  it('produces export JSON that deep-equals the compiled Blueprint and is not the raw draft representation', () => {
    const validDraft: ForgeDraft = {
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'The Facility Entity',
          role: 'Antagonist',
          description: 'Unclassified entity roaming the research facility.',
          disposition: 'VILLAIN',
      ...
      horrorGrammar: {
        ...
        pursuitReviews: { c1: 'REVIEWED_NONE', 'c-villain': 'REVIEWED_NONE' },
        valueAnchors: [],
        characterPursuits: [],
      },
    };
    ...
    const validDraftWithRefs: ForgeDraft = {
      ...
      cast: [
        ...
        },
        {
          ...
          role: 'Antagonist',
          description: 'Gaunt figure ringing the bell tower at midnight.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
  ...
  it('does not mutate the source draft', () => {
    const validDraft: ForgeDraft = {
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'The Bay Stalker',
          role: 'Antagonist',
          description: 'Predator nesting in the dark storage bay.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
  ...
  it('deep-freezes review artifact and compiled Blueprint so nested structures cannot be mutated, while source draft remains mutable', () => {
    const validDraft: ForgeDraft = {
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'The Sub-Level Stalker',
          role: 'Antagonist',
          description: 'Pale stalker haunting secure sub-level 9.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
  ...
  it('creates a deeply frozen artifact with both source revisions', () => {
    const validDraft: ForgeDraft = {
      ...
      cast: [
        ...
        {
          id: 'c-villain',
          name: 'The Chamber Entity',
          role: 'Antagonist',
          description: 'Unknown entity sealed inside chamber 4.',
          disposition: 'VILLAIN',
          behaviorVector: 'RELENTLESS',
          isEntity: true,
          isUserCharacter: false,
